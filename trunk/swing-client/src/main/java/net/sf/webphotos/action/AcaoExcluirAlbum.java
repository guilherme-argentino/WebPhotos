...
public class AcaoExcluirAlbum extends AbstractAction {
    ...
    /**
     * Método responsável pela ação de exclusão de albúns. Inicia uma tabela de
     * albúns para buscar as linhas selecionadas e checa quais e quantos foram
     * selecionados. Faz um controle de exclusão de no máximo 20 albúns por vez.
     * Lista os albúns selecionados ao usuário e pede uma confirmação de
