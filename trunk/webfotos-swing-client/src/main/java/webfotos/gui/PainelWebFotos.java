...
public class PainelWebFotos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        painelPesquisa = new webfotos.gui.PainelPesquisa();
        ...
        painelFoto = new webfotos.gui.PainelFoto();
        ...
        btFTP = new webfotos.gui.BotaoIcone();
        btUpload = new webfotos.gui.BotaoIcone();
        btDownload = new webfotos.gui.BotaoIcone();
        btAdicionarFotos = new webfotos.gui.BotaoIcone();
        ...
        lblTabelaInfo.setFont(new java.awt.Font("SansSerif", 0, 10));
        ...
        painelDadosAlbum.setLayout(new javax.swing.BoxLayout(painelDadosAlbum, javax.swing.BoxLayout.X_AXIS));
        ...
        txtLog.setFont(new java.awt.Font("Courier", 0, 11));
...
// TODO add your handling code here:
    ...
    /**
     * Seta o <I>cursor</I> em espera.
     * Recebe uma flag para setar o valor, caso seja <I>true</I>, mantém o cursor em espera,
     * caso o valor seja <I>false</I> seta o cursor com o valor <U>null</U>.
     ...
     * Seta a flag documentoAlterado para <I>false</I> e desabilita o botão alterar.
     * TODO: Reformular este sistema.
     ...
     * Checa se existe uma, mais de uma ou nenhuma linha selecionada, e apresenta o total de registros.
     */
     ...
     * Seta o botão btNovo com a função <B>novo</B> e o botão btAlterar com a função <B>alterar</B>.
     */
     ...
     * Limpa as variáveis e os controles.
     */
    ...
    private static webfotos.gui.BotaoIcone btAdicionarFotos;
    private static javax.swing.JButton btAlterar;
    private static webfotos.gui.BotaoIcone btDownload;
    private static webfotos.gui.BotaoIcone btFTP;
    private static javax.swing.JButton btNovo;
    private static webfotos.gui.BotaoIcone btUpload;
    ...
    private static webfotos.gui.PainelFoto painelFoto;
    private static javax.swing.JPanel painelInfoAlbum;
    private static webfotos.gui.PainelPesquisa painelPesquisa;
    ...
    /**
     * Retorna uma {@link javax.swing.text.MaskFormatter máscara}.
     * Utilizado na função de rotinas extras da própria classe.
    ...
    /**
     * Seta um valor de {@link javax.swing.text.MaskFormatter máscara} para mascaraData.
     * Não é utilizado.
