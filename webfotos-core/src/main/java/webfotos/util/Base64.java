                ...
                */
                ...
                chooser.addChoosableFileFilter(new javax.swing.filechooser.FileFilter() {
                    public boolean accept(java.io.File file) {
                        ...
                        return (filename.endsWith(".gif") || filename.endsWith(".jpg") || file.isDirectory());
                    }
                ...
                System.out.println("Arquivo: " + chooser.getSelectedFile().getAbsoluteFile());
                bytes = Base64.readFile(chooser.getSelectedFile().getAbsoluteFile(), false );
